...
{
    1,  1,  1,  1,  1,  1,  1,    // week-tab1 data   周日~周6  日时段表1//
...
{
    //日时段表1  //
    0,      0,      1,   //  day-tab1-chg1  data  0时0分费率1  //
    #if (MAX_DAY_TRIFF_CHG>1)
    0,      0,      0,   //  day-tab1-chg2  data  0时0分费率1  //
    #endif

    #if (MAX_DAY_TRIFF_CHG>2)
    0,      0,      0,  //  day-tab1-chg3  data  0时0分费率1  //
    #endif
    ...
    //日时段表2  //
    0,      0,      1,   //  day-tab2-chg1  data  0时0分费率1  //
    #if (MAX_DAY_TRIFF_CHG>1)
    0,      0,      0,  //  day-tab2-chg2  data  0时0分费率1  //
    #endif

    #if (MAX_DAY_TRIFF_CHG>2)
    0,      0,      0,   //  day-tab2-chg3  data  0时0分费率1  //
    #endif
